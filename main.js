    ...
    function generateSuggestionsArray(substationAPIResultObj, substationSourceObj) {
        ...
        if (substationAPIResultObj.dval > substationSourceObj.high_warning_limit) {
            suggestionsArray.push({
                message: "Switch off " + substationSourceObj["brIds"].length + " bus reactor(s)",
                brIds: BRStatusArray["on"],
            ...
            suggestionsArray.push({
                message: "Switch On " + substationSourceObj["brIds"].length + " bus reactor(s)",
                brIds: BRStatusArray["off"],
                pntId: substationSourceObj.pntId,
                color: "yellow"
            });
        }
...
function displaySuggestions() {
    var i = 0, k = 0;
    var suggestions = [];
    suggestions.push("<h2  style='color:white'>Suggestions</h2>" + "  \n");
